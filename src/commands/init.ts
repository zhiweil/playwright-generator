...
`;
    ...
    const packageJson = {
      ...
      scripts: {
        ...
        "test:case": "playwright test --reporter=list --grep",
        "test:debug": "playwright test --reporter=list --debug --project=chromium --grep",
        "test:headed": "playwright test --reporter=list --headed --grep",
        "test:browser": "playwright test --reporter=list --grep",
        "test:video": "playwright test --reporter=list --grep",
